    ...
    ws.onmessage = function (evt)
    {
        ...
        switch(msg.code)
        {
            ...
            case msg_tab['OBP_VALUE_ALL']:
                ...
                for ( i in msg.data )
                    change_input_value(String(msg.data[i]).substring(0,6), 'inp_' + OBP_tab[i]);
            ...
            case msg_tab['ASK_CHANGE']:
                if (main) //otherwise I don't know..
                {
                    ...
                    var answer = confirm('Client number ' + String(msg.data[0]) + ' ask to become the controler, do you want to become an observer?' );
